...
<body onload="slideCategoriapokemon(); loadpokemon(); llevarpokemon()">
    <div class="container-fluid">
        ...
        <div class="navegador col-4  flex-sm-column  " style="margin-left: 830px;">
            <div class="d-flex  ">
                <input style="font-size: 21px ; width: 300px; " name="btnbuscar" type="text" id="btnbuscar"
